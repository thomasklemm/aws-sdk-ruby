...
module Aws::BackupSearch
  describe EndpointProvider do
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-iso-east-1"}]}, "url"=>"https://backup-search-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-iso-east-1"}]}, "url"=>"https://backup-search.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-isob-east-1"}]}, "url"=>"https://backup-search-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-isob-east-1"}]}, "url"=>"https://backup-search.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"eu-isoe-west-1"}]}, "url"=>"https://backup-search-fips.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region eu-isoe-west-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"eu-isoe-west-1"}]}, "url"=>"https://backup-search.eu-isoe-west-1.cloud.adc-e.uk"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-isof-south-1"}]}, "url"=>"https://backup-search-fips.us-isof-south-1.csp.hci.ic.gov"}}
      end
    ...
    context "For region us-isof-south-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"properties"=>{"authSchemes"=>[{"name"=>"sigv4", "signingRegion"=>"us-isof-south-1"}]}, "url"=>"https://backup-search.us-isof-south-1.csp.hci.ic.gov"}}
      end
