...
module Aws::PartnerCentralSelling
  describe EndpointProvider do
    ...
    context "For region us-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.us-east-1.amazonaws.com"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.cn-north-1.api.amazonwebservices.com.cn"}}
      end
    ...
    context "For region cn-north-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.cn-north-1.amazonaws.com.cn"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack enabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.us-gov-east-1.api.aws"}}
      end
    ...
    context "For region us-gov-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.us-gov-east-1.amazonaws.com"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-iso-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.us-iso-east-1.c2s.ic.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS enabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling-fips.us-isob-east-1.sc2s.sgov.gov"}}
      end
    ...
    context "For region us-isob-east-1 with FIPS disabled and DualStack disabled" do
      let(:expected) do
        {"endpoint"=>{"url"=>"https://partnercentral-selling.us-isob-east-1.sc2s.sgov.gov"}}
      end
